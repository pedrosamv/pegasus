    ...
    dbc.Container([
        dbc.Nav([
            dbc.DropdownMenu(
                ...
                in_navbar=True,
                children=[
                    dbc.DropdownMenuItem("Que paso en la convertibilidad?"),
                    dbc.DropdownMenuItem("Como se genera la inflación?"),
                    dbc.DropdownMenuItem("Deuda Argentina, como se componen y como afecta la tasa de interés?")
                ],
            ),
            dbc.NavItem(
                dbc.NavLink(
