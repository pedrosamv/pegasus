...
df_mensual = pd.read_excel(r"C:\Users\usuario\Dropbox\Python\Pegasus\base_data.xlsx", sheet_name=0)
df_trimestral= pd.read_excel(r"C:\Users\usuario\Dropbox\Python\Pegasus\base_data.xlsx", sheet_name=1)
df_anual= pd.read_excel(r"C:\Users\usuario\Dropbox\Python\Pegasus\base_data.xlsx", sheet_name=2)
df_serie_pbi= pd.read_excel(r"C:\Users\usuario\Dropbox\Python\Pegasus\base_data.xlsx", sheet_name=3)
df_tasa= pd.read_excel(r"C:\Users\usuario\Dropbox\Python\Pegasus\base_data.xlsx", sheet_name=4)
df_tcn= pd.read_excel(r"C:\Users\usuario\Dropbox\Python\Pegasus\base_data.xlsx", sheet_name=5)
df_deuda= pd.read_excel(r"C:\Users\usuario\Dropbox\Python\Pegasus\base_data.xlsx", sheet_name=7)
df_des= pd.read_excel(r"C:\Users\usuario\Dropbox\Python\Pegasus\base_data.xlsx", sheet_name=8)
df_deuda_23= pd.read_excel(r"C:\Users\usuario\Dropbox\Python\Pegasus\base_data.xlsx", sheet_name=9)
df_lorenz=pd.read_excel(r"C:\Users\usuario\Dropbox\Python\Pegasus\base_data.xlsx", sheet_name=10)
 ...
 # ---- Filtro de Año ----
    ...
    dcc.Graph(id="grafico_lorenz"),
     dbc.Offcanvas(
        children=[
            html.P([
            "La curva de Lorenz muestra la distribucion del ingreso efectiva y la line de perfecta igualdad, entre mas alejada esten estas funciones, mayor sera la desigualdad. Es posible medir esta con el coeficiente de gini, el cual mide el area entre ambas curvas.",
            "Si observamos el primer semestre de 2024 podemos observar que ",
            html.Br(),
